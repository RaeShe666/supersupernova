...
import ChirpPage from './ChirpLovePage'
import {
  addPersonaToPlanet,
  BIRD,
  buildPersonaTheme,
...
import {
  ...
  uploadPersonaAvatar
} from './chirpLoveSupabase'
import './ChirpLoveHomePage.css'
...
export const CHIRP_PROFILE_KEY = 'chirpLoveOnboardingProfile'
...
export const OnboardingAnimalAvatar = ({ animal = 'cat' }) => {
  return <img src={`/chirp-love/animal-icons/${animal}.svg`} alt="" />
}
          ...
          <div className="bird-strip">
            ...
            <div className="bird-text">
              ...
              <div className="bird-msg">
                Morning, Goldie — last night in <em role="button" tabIndex="0" onClick={() => navigateTo('chirp.love', 'planet', 'love')} onKeyDown={(event) => event.key === 'Enter' && navigateTo('chirp.love', 'planet', 'love')}>my crush...</em> you wrote "never mind, let it go." That softness shows up a lot this week.
              </div>
            </div>
...
function PlanetCard({ planet, recent }) {
  ...
  return (
    <button className={`planet-card ${className}`} type="button" onClick={() => navigateTo('chirp.love', 'planet', planet.id)}>
          ...
          <div className="chirp-home-menu-list">
            <button
              ...
              onClick={() => {
                onClose()
                setMode('planets')
                navigateTo('chirp.love', 'planet', CHIRP_PLANETS[0].id)
              }}
            >
          ...
          <div className="chirp-home-drawer-planets">
            ...
            {planets.map(planet => (
              <DrawerPlanetCard
                ...
                onClick={() => {
                  onClose()
                  navigateTo('chirp.love', 'planet', planet.id)
                }}
              />
            ))}
          </div>

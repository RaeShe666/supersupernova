// Screenshot API using ScreenshotOne
// Full-page screenshot for comprehensive brand analysis
...
export default async function handler(req, res) {
    ...
    try {
        // Build ScreenshotOne API URL for full-page screenshot
        const params = new URLSearchParams({
            ...
            image_quality: '80',
            ignore_host_errors: 'true'  // Force screenshot even if site returns 406/403
        })

        const screenshotApiUrl = `https://api.screenshotone.com/take?${params.toString()}`

        // Fetch full-page screenshot
